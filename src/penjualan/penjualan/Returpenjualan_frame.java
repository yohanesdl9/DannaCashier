 ...
 * @author USER
 */
public class Returpenjualan_frame extends javax.swing.JFrame {

    Calendar cal = Calendar.getInstance();
    /**
     * Creates new form Returpenjualan_frame
     */
    public Returpenjualan_frame() {
        initComponents();
        try {
            tanggalRetur.setDate(new SimpleDateFormat("yyyy-MM-dd").parse(getDate(cal)));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "KODE", "NAMA", "JUMLAH", "SATUAN", "ISI", "TOTALISI", "HARGA JUAL", "TOTAL"
            }
        ));
        ...
        jLabel14.setText("TOTAL MENGURANGI PIUTANG");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Returpenjualan_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Returpenjualan_frame().setVisible(true);
            }
        });
    }
